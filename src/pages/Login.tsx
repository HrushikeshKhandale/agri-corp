...
const Login: React.FC = () => {
  ...
  const demoCredentials = [
    ...
    { role: 'Mumbai Store Manager', username: 'mumbai', password: 'mumbai123' },
    { role: 'Punjab Store Manager', username: 'punjab', password: 'punjab123' },
    { role: 'Store Employee', username: 'employee', password: 'emp123' }
  ];
